...
<body>
	...
	<div class="container">
		<h1>
			<spring:message code="local.header.add.article" />
		</h1>
		<c:if test="${not empty message}">
			<div class="error">${message}</div>
		</c:if>
		<form:form action="addArticle" modelAttribute="news" method="post">
			...
			<div class="form-group">
				<label for="categories"><spring:message
			...
			<div class="form-actions">
				<button type="submit">
					<spring:message code="local.admin.add" />
				</button>
			</div>
		</form:form>
	</div>
